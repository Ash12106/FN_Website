...
const facultyCoordinators: TeamMember[] = [
  { name: "Asst.Prof. Harshith C", role: "Faculty Coordinator", contact: "harshithc@vvce.ac.in", image: "/team/faculty_harshith_c.jpg" },
  { name: "Asst.Prof. Harshith V", role: "Faculty Coordinator", contact: "harshithv@vvce.ac.in", image: "/team/faculty_harshith_v.jpg" },
  { name: "Asst.Prof. Vignesh T V", role: "Faculty Coordinator", contact: "vigneshtv@vvce.ac.in", image: "/team/faculty_vignesh.jpg" },
  { name: "Asst.Prof. Revathy B D", role: "Faculty Coordinator", contact: "revathybd@vvce.ac.in", image: "/team/faculty_revathy.jpg" },
];
    ...
    <section ref={containerRef} id="team" className="max-w-7xl w-full py-32 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="flex flex-col gap-24 relative z-10">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-white/40 text-lg italic tracking-[0.25em] font-light max-w-2xl mx-auto pt-6">
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {facultyCoordinators.map((member, i) => (
              ...
              >
                <div className="glass-card p-6 rounded-[2rem] border-primary/10 bg-white/2 overflow-hidden text-center flex flex-col items-center">
                  {/* Scanline Effect */}
                  <div className="absolute inset-0 bg-linear-to-b from-transparent via-primary/5 to-transparent h-1/2 w-full animate-scanline opacity-10 pointer-events-none"></div>
                  
                  <div className="relative mb-6">
                    <div className="w-24 h-24 rounded-full border-2 border-primary/20 p-1 transition-colors">
                  ...
                  <div className="space-y-1 mb-4">
                    <h4 className="text-lg font-bold text-white transition-colors">{member.name}</h4>
        ...
        <div className="space-y-12">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-2xl font-display font-black text-white uppercase tracking-widest italic">Student<span className="text-primary italic"> Core Team</span></h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {studentCoreTeam.map((member, i) => (
              <motion.div 
                ...
                className="relative"
              >
                <div className="glass-card p-8 rounded-[2.5rem] border-white/5 bg-white/2 overflow-hidden transition-all duration-500 flex flex-col items-center">
                  ...
                  <div className="relative mb-6">
                    <div className="w-20 h-20 rounded-2xl border-2 border-primary/20 p-1 transition-all duration-500 overflow-hidden">
                      <div className="w-full h-full bg-black/40 overflow-hidden transition-all duration-500">
                        <img 
                          src={member.image} 
                          alt={member.name} 
                  ...
                  <div className="text-center space-y-1 mb-4">
                    <h4 className="text-xl font-bold text-white transition-colors">{member.name}</h4>
                  ...
                  <div className="w-full pt-4 border-t border-white/5 space-y-3">
                    ...
                    <div className="flex gap-4 justify-center">
                      <div className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/5 transition-colors">
