...
export default function DomeGallery({
  ...
  return (
    <div ref={rootRef} className="sphere-root" style={{ '--segments-x': segments, '--segments-y': segments }}>
        ...
        <div className="stage">
          <div ref={sphereRef} className="sphere">
            {items.map((it, i) => (
              ...
              >
                <div className="item__image" role="button" tabIndex={0} aria-label={it.alt} onClick={onTileClick} onPointerUp={onTilePointerUp}>
